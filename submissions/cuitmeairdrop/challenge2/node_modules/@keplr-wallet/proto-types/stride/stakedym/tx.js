...
const stakedym_1 = require("../../stride/stakedym/stakedym");
    ...
    fromJSON(object) {
        return {
            ...
            delegationRecord: isSet(object.delegationRecord)
                ? stakedym_1.DelegationRecord.fromJSON(object.delegationRecord)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.delegationRecord !== undefined &&
            (obj.delegationRecord = message.delegationRecord
                ? stakedym_1.DelegationRecord.toJSON(message.delegationRecord)
                : undefined);
        return obj;
    },
    fromPartial(object) {
    ...
    fromJSON(object) {
        return {
            ...
            unbondingRecord: isSet(object.unbondingRecord)
                ? stakedym_1.UnbondingRecord.fromJSON(object.unbondingRecord)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.unbondingRecord !== undefined &&
            (obj.unbondingRecord = message.unbondingRecord
                ? stakedym_1.UnbondingRecord.toJSON(message.unbondingRecord)
                : undefined);
        return obj;
    },
    fromPartial(object) {
    ...
    fromJSON(object) {
        return {
            ...
            redemptionRecord: isSet(object.redemptionRecord)
                ? stakedym_1.RedemptionRecord.fromJSON(object.redemptionRecord)
                : undefined,
        };
    },
    toJSON(message) {
        ...
        message.redemptionRecord !== undefined &&
            (obj.redemptionRecord = message.redemptionRecord
                ? stakedym_1.RedemptionRecord.toJSON(message.redemptionRecord)
                : undefined);
        return obj;
    },
    fromPartial(object) {
