...
exports.ModuleDescriptor = {
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.use_package) === null || _a === void 0 ? void 0 : _a.length) {
            obj.use_package = message.use_package.map(function (e) { return exports.PackageReference.toJSON(e); });
        }
        if ((_b = message.can_migrate_from) === null || _b === void 0 ? void 0 : _b.length) {
            obj.can_migrate_from = message.can_migrate_from.map(function (e) { return exports.MigrateFromInfo.toJSON(e); });
        }
        return obj;
    },
