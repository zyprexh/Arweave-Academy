...
exports.ScalarDescriptor = {
    ...
    fromJSON: function (object) {
        return {
            name: isSet(object.name) ? globalThis.String(object.name) : "",
            description: isSet(object.description) ? globalThis.String(object.description) : "",
            field_type: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.field_type)
                ? object.field_type.map(function (e) { return scalarTypeFromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.field_type) === null || _a === void 0 ? void 0 : _a.length) {
