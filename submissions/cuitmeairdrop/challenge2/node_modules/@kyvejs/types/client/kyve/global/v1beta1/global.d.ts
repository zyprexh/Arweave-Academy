...
export declare const Params: {
    ...
    fromPartial<I_1 extends {
        ...
        gas_adjustments?: ({
            ...
            type?: string | undefined;
            amount?: string | undefined;
        } & { [K_5 in Exclude<keyof I_1["gas_adjustments"][number], keyof GasAdjustment>]: never; })[] & { [K_6 in Exclude<keyof I_1["gas_adjustments"], keyof {
            type?: string | undefined;
            amount?: string | undefined;
        }[]>]: never; }) | undefined;
        gas_refunds?: ({
            ...
            type?: string | undefined;
            fraction?: string | undefined;
        } & { [K_7 in Exclude<keyof I_1["gas_refunds"][number], keyof GasRefund>]: never; })[] & { [K_8 in Exclude<keyof I_1["gas_refunds"], keyof {
            type?: string | undefined;
            fraction?: string | undefined;
        }[]>]: never; }) | undefined;
        min_initial_deposit_ratio?: string | undefined;
...
export declare const GasAdjustment: {
    ...
    create<I extends {
        ...
        type?: string | undefined;
        amount?: string | undefined;
    } & { [K in Exclude<keyof I, keyof GasAdjustment>]: never; }>(base?: I | undefined): GasAdjustment;
    fromPartial<I_1 extends {
        type?: string | undefined;
        amount?: string | undefined;
    } & {
        type?: string | undefined;
        amount?: string | undefined;
    } & { [K_1 in Exclude<keyof I_1, keyof GasAdjustment>]: never; }>(object: I_1): GasAdjustment;
};
export declare const GasRefund: {
    ...
    create<I extends {
        ...
        type?: string | undefined;
        fraction?: string | undefined;
    } & { [K in Exclude<keyof I, keyof GasRefund>]: never; }>(base?: I | undefined): GasRefund;
    fromPartial<I_1 extends {
        type?: string | undefined;
        fraction?: string | undefined;
    } & {
        type?: string | undefined;
        fraction?: string | undefined;
    } & { [K_1 in Exclude<keyof I_1, keyof GasRefund>]: never; }>(object: I_1): GasRefund;
};
