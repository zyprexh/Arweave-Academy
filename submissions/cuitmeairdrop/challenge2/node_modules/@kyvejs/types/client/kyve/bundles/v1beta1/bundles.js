...
exports.RoundRobinProgress = exports.RoundRobinSingleValidatorProgress = exports.BundleVersionMap = exports.BundleVersionEntry = exports.StakeSecurity = exports.FinalizedAt = exports.FinalizedBundle = exports.BundleProposal = exports.bundleStatusToJSON = exports.bundleStatusFromJSON = exports.BundleStatus = exports.protobufPackage = void 0;
/* eslint-disable */
...
(function (BundleStatus) {
    ...
    BundleStatus[BundleStatus["BUNDLE_STATUS_DISABLED"] = 5] = "BUNDLE_STATUS_DISABLED";
...
exports.BundleProposal = {
    ...
    fromJSON: function (object) {
        return {
            ...
            voters_valid: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.voters_valid)
                ? object.voters_valid.map(function (e) { return globalThis.String(e); })
                : [],
            voters_invalid: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.voters_invalid)
                ? object.voters_invalid.map(function (e) { return globalThis.String(e); })
                : [],
            voters_abstain: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.voters_abstain)
                ? object.voters_abstain.map(function (e) { return globalThis.String(e); })
                : [],
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.voters_valid) === null || _a === void 0 ? void 0 : _a.length) {
            obj.voters_valid = message.voters_valid;
        }
        if ((_b = message.voters_invalid) === null || _b === void 0 ? void 0 : _b.length) {
            obj.voters_invalid = message.voters_invalid;
        }
        if ((_c = message.voters_abstain) === null || _c === void 0 ? void 0 : _c.length) {
    ...
    create: function (base) {
        return exports.BundleProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
...
exports.FinalizedBundle = {
    ...
    fromPartial: function (object) {
        ...
        message.finalized_at = (object.finalized_at !== undefined && object.finalized_at !== null)
            ...
            : undefined;
        message.from_key = (_k = object.from_key) !== null && _k !== void 0 ? _k : "";
...
exports.StakeSecurity = {
    ...
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseStakeSecurity();
        message.valid_vote_power = (_a = object.valid_vote_power) !== null && _a !== void 0 ? _a : "0";
        message.total_vote_power = (_b = object.total_vote_power) !== null && _b !== void 0 ? _b : "0";
        return message;
    },
};
...
exports.BundleVersionEntry = {
    ...
    create: function (base) {
        return exports.BundleVersionEntry.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseBundleVersionEntry();
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.versions.push(exports.BundleVersionEntry.decode(reader, reader.uint32()));
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON: function (object) {
        return {
            versions: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.versions)
                ? object.versions.map(function (e) { return exports.BundleVersionEntry.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.versions) === null || _a === void 0 ? void 0 : _a.length) {
            obj.versions = message.versions.map(function (e) { return exports.BundleVersionEntry.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
        return exports.BundleVersionMap.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseBundleVersionMap();
        message.versions = ((_a = object.versions) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exports.BundleVersionEntry.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.RoundRobinSingleValidatorProgress = {
    ...
    create: function (base) {
        return exports.RoundRobinSingleValidatorProgress.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseRoundRobinSingleValidatorProgress();
...
exports.RoundRobinProgress = {
    encode: function (message, writer) {
        ...
        for (var _i = 0, _a = message.progress_list; _i < _a.length; _i++) {
            var v = _a[_i];
            exports.RoundRobinSingleValidatorProgress.encode(v, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.progress_list.push(exports.RoundRobinSingleValidatorProgress.decode(reader, reader.uint32()));
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON: function (object) {
        return {
            pool_id: isSet(object.pool_id) ? globalThis.String(object.pool_id) : "0",
            progress_list: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.progress_list)
                ? object.progress_list.map(function (e) { return exports.RoundRobinSingleValidatorProgress.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.progress_list) === null || _a === void 0 ? void 0 : _a.length) {
            obj.progress_list = message.progress_list.map(function (e) { return exports.RoundRobinSingleValidatorProgress.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
        return exports.RoundRobinProgress.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseRoundRobinProgress();
        message.pool_id = (_a = object.pool_id) !== null && _a !== void 0 ? _a : "0";
        message.progress_list = ((_b = object.progress_list) === null || _b === void 0 ? void 0 : _b.map(function (e) { return exports.RoundRobinSingleValidatorProgress.fromPartial(e); })) || [];
        return message;
    },
};
