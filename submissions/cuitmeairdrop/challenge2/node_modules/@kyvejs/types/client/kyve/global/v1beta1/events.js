...
exports.EventUpdateParams = {
    encode: function (message, writer) {
        ...
        if (message.old_params !== undefined) {
            global_1.Params.encode(message.old_params, writer.uint32(10).fork()).ldelim();
        }
        if (message.new_params !== undefined) {
            global_1.Params.encode(message.new_params, writer.uint32(18).fork()).ldelim();
        }
        if (message.payload !== "") {
    ...
    fromJSON: function (object) {
        return {
            old_params: isSet(object.old_params) ? global_1.Params.fromJSON(object.old_params) : undefined,
            new_params: isSet(object.new_params) ? global_1.Params.fromJSON(object.new_params) : undefined,
