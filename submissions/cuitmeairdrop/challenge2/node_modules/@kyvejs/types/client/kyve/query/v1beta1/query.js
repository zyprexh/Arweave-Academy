...
exports.StakerMetadata = {
    encode: function (message, writer) {
        ...
        if (message.pending_commission_change !== undefined) {
            exports.CommissionChangeEntry.encode(message.pending_commission_change, writer.uint32(58).fork()).ldelim();
        }
    ...
    create: function (base) {
        return exports.StakerMetadata.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        ...
        message.pending_commission_change =
            (object.pending_commission_change !== undefined && object.pending_commission_change !== null)
                ...
                : undefined;
        message.commission_rewards = ((_g = object.commission_rewards) === null || _g === void 0 ? void 0 : _g.map(function (e) { return coin_1.Coin.fromPartial(e); })) || [];
        return message;
    },
};
