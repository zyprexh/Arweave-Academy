...
exports.QueryStakersClientImpl = exports.QueryStakersServiceName = exports.QueryStakersByPoolCountResponse = exports.QueryStakersByPoolCountRequest = exports.StakerPoolResponse = exports.QueryStakersByPoolResponse = exports.QueryStakersByPoolRequest = exports.QueryStakerResponse = exports.QueryStakerRequest = exports.QueryStakersResponse = exports.QueryStakersRequest = exports.stakerStatusToJSON = exports.stakerStatusFromJSON = exports.StakerStatus = exports.protobufPackage = void 0;
/* eslint-disable */
...
(function (StakerStatus) {
    ...
    StakerStatus[StakerStatus["STAKER_STATUS_UNSPECIFIED"] = 0] = "STAKER_STATUS_UNSPECIFIED";
    /** STAKER_STATUS_ACTIVE - STAKER_STATUS_ACTIVE ... */
    StakerStatus[StakerStatus["STAKER_STATUS_ACTIVE"] = 1] = "STAKER_STATUS_ACTIVE";
    /** STAKER_STATUS_INACTIVE - STAKER_STATUS_INACTIVE ... */
    StakerStatus[StakerStatus["STAKER_STATUS_INACTIVE"] = 2] = "STAKER_STATUS_INACTIVE";
    StakerStatus[StakerStatus["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
    ...
    fromJSON: function (object) {
        return {
            stakers: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.stakers)
                ? object.stakers.map(function (e) { return exports.StakerPoolResponse.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        var obj = {};
        if ((_a = message.stakers) === null || _a === void 0 ? void 0 : _a.length) {
            obj.stakers = message.stakers.map(function (e) { return exports.StakerPoolResponse.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
...
exports.StakerPoolResponse = {
    ...
    toJSON: function (message) {
        ...
        if (message.valaccount !== undefined) {
            obj.valaccount = stakers_1.Valaccount.toJSON(message.valaccount);
        }
        return obj;
    },
    create: function (base) {
        return exports.StakerPoolResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var message = createBaseStakerPoolResponse();
        message.staker = (object.staker !== undefined && object.staker !== null)
...
exports.QueryStakersServiceName = "kyve.query.v1beta1.QueryStakers";
var QueryStakersClientImpl = /** @class */ (function () {
    ...
    QueryStakersClientImpl.prototype.Stakers = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryStakersResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    QueryStakersClientImpl.prototype.Staker = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryStakerResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    QueryStakersClientImpl.prototype.StakersByPool = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryStakersByPoolResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    QueryStakersClientImpl.prototype.StakersByPoolCount = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryStakersByPoolCountResponse.decode(minimal_1.default.Reader.create(data)); });
    };
