...
exports.EventPoolFundsSlashed = exports.EventPoolUpdated = exports.EventRuntimeUpgradeCancelled = exports.EventRuntimeUpgradeScheduled = exports.EventPoolDisabled = exports.EventPoolEnabled = exports.EventCreatePool = exports.EventUpdateParams = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.EventCreatePool = {
    ...
    create: function (base) {
        return exports.EventCreatePool.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
...
exports.EventPoolEnabled = {
    ...
    create: function (base) {
        return exports.EventPoolEnabled.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseEventPoolEnabled();
...
exports.EventPoolDisabled = {
    ...
    create: function (base) {
        return exports.EventPoolDisabled.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseEventPoolDisabled();
...
exports.EventRuntimeUpgradeScheduled = {
    ...
    fromJSON: function (object) {
        return {
            ...
            binaries: isSet(object.binaries) ? globalThis.String(object.binaries) : "",
            affected_pools: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.affected_pools)
                ? object.affected_pools.map(function (e) { return globalThis.String(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.affected_pools) === null || _a === void 0 ? void 0 : _a.length) {
            obj.affected_pools = message.affected_pools;
        }
        return obj;
    },
    create: function (base) {
        return exports.EventRuntimeUpgradeScheduled.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        ...
        message.binaries = (_e = object.binaries) !== null && _e !== void 0 ? _e : "";
        message.affected_pools = ((_f = object.affected_pools) === null || _f === void 0 ? void 0 : _f.map(function (e) { return e; })) || [];
        return message;
    },
};
...
exports.EventRuntimeUpgradeCancelled = {
    ...
    create: function (base) {
        return exports.EventRuntimeUpgradeCancelled.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseEventRuntimeUpgradeCancelled();
        message.runtime = (_a = object.runtime) !== null && _a !== void 0 ? _a : "";
        message.affected_pools = ((_b = object.affected_pools) === null || _b === void 0 ? void 0 : _b.map(function (e) { return e; })) || [];
        return message;
    },
};
...
exports.EventPoolUpdated = {
    ...
    create: function (base) {
        return exports.EventPoolUpdated.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
        var message = createBaseEventPoolUpdated();
        message.id = (_a = object.id) !== null && _a !== void 0 ? _a : "0";
        message.raw_update_string = (_b = object.raw_update_string) !== null && _b !== void 0 ? _b : "";
...
exports.EventPoolFundsSlashed = {
    ...
    create: function (base) {
        return exports.EventPoolFundsSlashed.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c;
        var message = createBaseEventPoolFundsSlashed();
