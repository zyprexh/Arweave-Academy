...
exports.QueryBundlesClientImpl = exports.QueryBundlesServiceName = exports.QueryCanVoteResponse = exports.QueryCanVoteRequest = exports.QueryCanProposeResponse = exports.QueryCanProposeRequest = exports.QueryCanValidateResponse = exports.QueryCanValidateRequest = exports.QueryCurrentVoteStatusResponse = exports.QueryCurrentVoteStatusRequest = exports.QueryFinalizedBundleResponse = exports.QueryFinalizedBundleRequest = exports.QueryFinalizedBundlesResponse = exports.QueryFinalizedBundlesRequest = exports.StakeSecurity = exports.FinalizedAt = exports.FinalizedBundle = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.FinalizedBundle = {
    encode: function (message, writer) {
        ...
        if (message.finalized_at !== undefined) {
            exports.FinalizedAt.encode(message.finalized_at, writer.uint32(82).fork()).ldelim();
        }
        ...
        if (message.stake_security !== undefined) {
            exports.StakeSecurity.encode(message.stake_security, writer.uint32(114).fork()).ldelim();
        }
        return writer;
    },
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 10:
                    ...
                    message.finalized_at = exports.FinalizedAt.decode(reader, reader.uint32());
                    continue;
                case 12:
                    if (tag !== 96) {
                        break;
                ...
                case 14:
                    ...
                    message.stake_security = exports.StakeSecurity.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON: function (object) {
        return {
            ...
            finalized_at: isSet(object.finalized_at) ? exports.FinalizedAt.fromJSON(object.finalized_at) : undefined,
            ...
            stake_security: isSet(object.stake_security) ? exports.StakeSecurity.fromJSON(object.stake_security) : undefined,
        };
    },
    ...
    create: function (base) {
        return exports.FinalizedBundle.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        ...
        message.bundle_summary = (_j = object.bundle_summary) !== null && _j !== void 0 ? _j : "";
        message.data_hash = (_k = object.data_hash) !== null && _k !== void 0 ? _k : "";
        message.finalized_at = (object.finalized_at !== undefined && object.finalized_at !== null)
            ...
            : undefined;
        message.storage_provider_id = (_l = object.storage_provider_id) !== null && _l !== void 0 ? _l : "0";
        message.compression_id = (_m = object.compression_id) !== null && _m !== void 0 ? _m : "0";
...
exports.FinalizedAt = {
    ...
    create: function (base) {
        return exports.FinalizedAt.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseFinalizedAt();
...
exports.StakeSecurity = {
    ...
    create: function (base) {
        return exports.StakeSecurity.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseStakeSecurity();
        message.valid_vote_power = (_a = object.valid_vote_power) !== null && _a !== void 0 ? _a : "";
        message.total_vote_power = (_b = object.total_vote_power) !== null && _b !== void 0 ? _b : "";
        return message;
    },
};
...
exports.QueryFinalizedBundlesRequest = {
    ...
    create: function (base) {
        return exports.QueryFinalizedBundlesRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseQueryFinalizedBundlesRequest();
...
exports.QueryFinalizedBundlesResponse = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.finalized_bundles.push(exports.FinalizedBundle.decode(reader, reader.uint32()));
                    continue;
                case 2:
                    if (tag !== 18) {
                        break;
    ...
    fromJSON: function (object) {
        return {
            finalized_bundles: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.finalized_bundles)
                ? object.finalized_bundles.map(function (e) { return exports.FinalizedBundle.fromJSON(e); })
                : [],
    ...
    toJSON: function (message) {
        var _a;
        var obj = {};
        if ((_a = message.finalized_bundles) === null || _a === void 0 ? void 0 : _a.length) {
            obj.finalized_bundles = message.finalized_bundles.map(function (e) { return exports.FinalizedBundle.toJSON(e); });
        }
        if (message.pagination !== undefined) {
    ...
    create: function (base) {
        return exports.QueryFinalizedBundlesResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryFinalizedBundlesResponse();
        message.finalized_bundles = ((_a = object.finalized_bundles) === null || _a === void 0 ? void 0 : _a.map(function (e) { return exports.FinalizedBundle.fromPartial(e); })) || [];
        message.pagination = (object.pagination !== undefined && object.pagination !== null)
...
exports.QueryFinalizedBundleRequest = {
    ...
    create: function (base) {
        return exports.QueryFinalizedBundleRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseQueryFinalizedBundleRequest();
...
exports.QueryFinalizedBundleResponse = {
    ...
    create: function (base) {
        return exports.QueryFinalizedBundleResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m;
        var message = createBaseQueryFinalizedBundleResponse();
...
exports.QueryCurrentVoteStatusRequest = {
    ...
    create: function (base) {
        return exports.QueryCurrentVoteStatusRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryCurrentVoteStatusRequest();
...
exports.QueryCurrentVoteStatusResponse = {
    ...
    create: function (base) {
        return exports.QueryCurrentVoteStatusResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d;
        var message = createBaseQueryCurrentVoteStatusResponse();
...
exports.QueryCanValidateRequest = {
    ...
    create: function (base) {
        return exports.QueryCanValidateRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseQueryCanValidateRequest();
...
exports.QueryCanValidateResponse = {
    ...
    create: function (base) {
        return exports.QueryCanValidateResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseQueryCanValidateResponse();
...
exports.QueryCanProposeRequest = {
    ...
    create: function (base) {
        return exports.QueryCanProposeRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d;
        var message = createBaseQueryCanProposeRequest();
...
exports.QueryCanProposeResponse = {
    ...
    create: function (base) {
        return exports.QueryCanProposeResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseQueryCanProposeResponse();
...
exports.QueryCanVoteRequest = {
    ...
    create: function (base) {
        return exports.QueryCanVoteRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d;
        var message = createBaseQueryCanVoteRequest();
...
exports.QueryCanVoteResponse = {
    ...
    create: function (base) {
        return exports.QueryCanVoteResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseQueryCanVoteResponse();
...
var QueryBundlesClientImpl = /** @class */ (function () {
    function QueryBundlesClientImpl(rpc, opts) {
        this.service = (opts === null || opts === void 0 ? void 0 : opts.service) || exports.QueryBundlesServiceName;
        this.rpc = rpc;
    ...
    QueryBundlesClientImpl.prototype.FinalizedBundlesQuery = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryFinalizedBundlesResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    QueryBundlesClientImpl.prototype.FinalizedBundleQuery = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryFinalizedBundleResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    QueryBundlesClientImpl.prototype.CurrentVoteStatus = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryCurrentVoteStatusResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    QueryBundlesClientImpl.prototype.CanValidate = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryCanValidateResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    QueryBundlesClientImpl.prototype.CanPropose = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryCanProposeResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    QueryBundlesClientImpl.prototype.CanVote = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryCanVoteResponse.decode(minimal_1.default.Reader.create(data)); });
    };
