...
exports.MsgSubmitProposal = {
    ...
    fromJSON: function (object) {
        return {
            messages: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.messages) ? object.messages.map(function (e) { return any_1.Any.fromJSON(e); }) : [],
            initial_deposit: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.initial_deposit)
    ...
    toJSON: function (message) {
        ...
        if ((_b = message.initial_deposit) === null || _b === void 0 ? void 0 : _b.length) {
            obj.initial_deposit = message.initial_deposit.map(function (e) { return coin_1.Coin.toJSON(e); });
        }
        if (message.proposer !== "") {
...
exports.MsgVoteWeighted = {
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.options) === null || _a === void 0 ? void 0 : _a.length) {
            obj.options = message.options.map(function (e) { return gov_1.WeightedVoteOption.toJSON(e); });
        }
        if (message.metadata !== "") {
            obj.metadata = message.metadata;
        }
...
exports.MsgDeposit = {
    ...
    fromJSON: function (object) {
        return {
            ...
            amount: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.amount) ? object.amount.map(function (e) { return coin_1.Coin.fromJSON(e); }) : [],
        };
    },
    toJSON: function (message) {
        var _a;
        ...
        if ((_a = message.amount) === null || _a === void 0 ? void 0 : _a.length) {
            obj.amount = message.amount.map(function (e) { return coin_1.Coin.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
...
exports.MsgCancelProposalResponse = {
    encode: function (message, writer) {
        ...
        if (message.canceled_time !== undefined) {
            timestamp_1.Timestamp.encode(toTimestamp(message.canceled_time), writer.uint32(18).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.canceled_time = fromTimestamp(timestamp_1.Timestamp.decode(reader, reader.uint32()));
                    continue;
                case 3:
                    if (tag !== 24) {
                        break;
    ...
    fromPartial: function (object) {
        ...
        var message = createBaseMsgCancelProposalResponse();
        message.proposal_id = (_a = object.proposal_id) !== null && _a !== void 0 ? _a : "0";
        message.canceled_time = (_b = object.canceled_time) !== null && _b !== void 0 ? _b : undefined;
        message.canceled_height = (_c = object.canceled_height) !== null && _c !== void 0 ? _c : "0";
        return message;
    },
};
...
var MsgClientImpl = /** @class */ (function () {
    ...
    MsgClientImpl.prototype.SubmitProposal = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgSubmitProposalResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    MsgClientImpl.prototype.ExecLegacyContent = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgExecLegacyContentResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    MsgClientImpl.prototype.Vote = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgVoteResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    MsgClientImpl.prototype.VoteWeighted = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgVoteWeightedResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    MsgClientImpl.prototype.Deposit = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgDepositResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    ...
    MsgClientImpl.prototype.CancelProposal = function (request) {
        var data = exports.MsgCancelProposal.encode(request).finish();
        var promise = this.rpc.request(this.service, "CancelProposal", data);
        return promise.then(function (data) { return exports.MsgCancelProposalResponse.decode(minimal_1.default.Reader.create(data)); });
    };
