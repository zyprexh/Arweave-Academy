...
exports.Params = exports.TallyParams = exports.VotingParams = exports.DepositParams = exports.Vote = exports.TallyResult = exports.Proposal = exports.Deposit = exports.WeightedVoteOption = exports.proposalStatusToNumber = exports.proposalStatusToJSON = exports.proposalStatusFromJSON = exports.ProposalStatus = exports.voteOptionToNumber = exports.voteOptionToJSON = exports.voteOptionFromJSON = exports.VoteOption = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.Proposal = {
    ...
    fromJSON: function (object) {
        return {
            ...
            total_deposit: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.total_deposit)
    ...
    toJSON: function (message) {
        ...
        if ((_b = message.total_deposit) === null || _b === void 0 ? void 0 : _b.length) {
            obj.total_deposit = message.total_deposit.map(function (e) { return coin_1.Coin.toJSON(e); });
        }
        if (message.voting_start_time !== undefined) {
    ...
    fromPartial: function (object) {
        ...
        message.failed_reason = (_p = object.failed_reason) !== null && _p !== void 0 ? _p : "";
        return message;
    },
};
...
exports.Vote = {
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.options) === null || _a === void 0 ? void 0 : _a.length) {
            obj.options = message.options.map(function (e) { return exports.WeightedVoteOption.toJSON(e); });
        }
        if (message.metadata !== "") {
            obj.metadata = message.metadata;
        }
...
exports.DepositParams = {
    ...
    fromJSON: function (object) {
        return {
            min_deposit: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.min_deposit)
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.min_deposit) === null || _a === void 0 ? void 0 : _a.length) {
            obj.min_deposit = message.min_deposit.map(function (e) { return coin_1.Coin.toJSON(e); });
        }
        if (message.max_deposit_period !== undefined) {
...
exports.Params = {
    encode: function (message, writer) {
        ...
        for (var _b = 0, _c = message.expedited_min_deposit; _b < _c.length; _b++) {
            var v = _c[_b];
    ...
    fromJSON: function (object) {
        return {
            ...
            expedited_min_deposit: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.expedited_min_deposit)
                ? object.expedited_min_deposit.map(function (e) { return coin_1.Coin.fromJSON(e); })
                : [],
    ...
    toJSON: function (message) {
        ...
        if ((_b = message.expedited_min_deposit) === null || _b === void 0 ? void 0 : _b.length) {
            obj.expedited_min_deposit = message.expedited_min_deposit.map(function (e) { return coin_1.Coin.toJSON(e); });
        }
        if (message.burn_vote_quorum !== false) {
    ...
    fromPartial: function (object) {
        ...
        message.expedited_min_deposit = ((_j = object.expedited_min_deposit) === null || _j === void 0 ? void 0 : _j.map(function (e) { return coin_1.Coin.fromPartial(e); })) || [];
