...
exports.QueryParamsClientImpl = exports.QueryParamsServiceName = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.QueryParamsResponse = {
    encode: function (message, writer) {
        ...
        if (message.global_params !== undefined) {
            global_1.Params.encode(message.global_params, writer.uint32(26).fork()).ldelim();
        }
        if (message.gov_params !== undefined) {
            gov_1.Params.encode(message.gov_params, writer.uint32(34).fork()).ldelim();
        }
        if (message.stakers_params !== undefined) {
            params_5.Params.encode(message.stakers_params, writer.uint32(42).fork()).ldelim();
        }
        if (message.pool_params !== undefined) {
            params_4.Params.encode(message.pool_params, writer.uint32(50).fork()).ldelim();
        }
        if (message.funders_params !== undefined) {
            params_3.Params.encode(message.funders_params, writer.uint32(58).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 3:
                    ...
                    message.global_params = global_1.Params.decode(reader, reader.uint32());
                    continue;
                case 4:
                    if (tag !== 34) {
                        break;
                ...
                case 5:
                    ...
                    message.stakers_params = params_5.Params.decode(reader, reader.uint32());
                    continue;
                case 6:
                    if (tag !== 50) {
                        break;
                ...
                case 7:
                    ...
                    message.funders_params = params_3.Params.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON: function (object) {
        return {
            ...
            global_params: isSet(object.global_params) ? global_1.Params.fromJSON(object.global_params) : undefined,
            gov_params: isSet(object.gov_params) ? gov_1.Params.fromJSON(object.gov_params) : undefined,
            stakers_params: isSet(object.stakers_params) ? params_5.Params.fromJSON(object.stakers_params) : undefined,
            pool_params: isSet(object.pool_params) ? params_4.Params.fromJSON(object.pool_params) : undefined,
            funders_params: isSet(object.funders_params) ? params_3.Params.fromJSON(object.funders_params) : undefined,
        };
    },
...
var QueryParamsClientImpl = /** @class */ (function () {
    function QueryParamsClientImpl(rpc, opts) {
        this.service = (opts === null || opts === void 0 ? void 0 : opts.service) || exports.QueryParamsServiceName;
        this.rpc = rpc;
    ...
    QueryParamsClientImpl.prototype.Params = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryParamsResponse.decode(minimal_1.default.Reader.create(data)); });
    };
