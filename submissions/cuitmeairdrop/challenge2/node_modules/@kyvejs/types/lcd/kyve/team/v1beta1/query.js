...
exports.QueryClientImpl = exports.QueryServiceName = exports.QueryVestingPlan = exports.QueryVestingStatus = exports.QueryTeamVestingStatusByTimeResponse = exports.QueryTeamVestingStatusByTimeRequest = exports.QueryTeamVestingStatusResponse = exports.QueryTeamVestingStatusRequest = exports.QueryTeamVestingAccountResponse = exports.QueryTeamVestingAccountRequest = exports.QueryTeamVestingAccountsResponse = exports.QueryTeamVestingAccountsRequest = exports.QueryTeamInfoResponse = exports.QueryTeamInfoRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.QueryTeamInfoRequest = {
    ...
    create: function (base) {
        return exports.QueryTeamInfoRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
...
exports.QueryTeamInfoResponse = {
    ...
    create: function (base) {
        return exports.QueryTeamInfoResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o;
        var message = createBaseQueryTeamInfoResponse();
        message.foundation_authority = (_a = object.foundation_authority) !== null && _a !== void 0 ? _a : "";
        message.bcp_authority = (_b = object.bcp_authority) !== null && _b !== void 0 ? _b : "";
        message.total_team_allocation = (_c = object.total_team_allocation) !== null && _c !== void 0 ? _c : "0";
        message.issued_team_allocation = (_d = object.issued_team_allocation) !== null && _d !== void 0 ? _d : "0";
        message.available_team_allocation = (_e = object.available_team_allocation) !== null && _e !== void 0 ? _e : "0";
        message.total_authority_rewards = (_f = object.total_authority_rewards) !== null && _f !== void 0 ? _f : "0";
        message.claimed_authority_rewards = (_g = object.claimed_authority_rewards) !== null && _g !== void 0 ? _g : "0";
        message.available_authority_rewards = (_h = object.available_authority_rewards) !== null && _h !== void 0 ? _h : "0";
        message.total_account_rewards = (_j = object.total_account_rewards) !== null && _j !== void 0 ? _j : "0";
        message.claimed_account_rewards = (_k = object.claimed_account_rewards) !== null && _k !== void 0 ? _k : "0";
        message.available_account_rewards = (_l = object.available_account_rewards) !== null && _l !== void 0 ? _l : "0";
        message.required_module_balance = (_m = object.required_module_balance) !== null && _m !== void 0 ? _m : "0";
        message.team_module_balance = (_o = object.team_module_balance) !== null && _o !== void 0 ? _o : "0";
        return message;
    },
};
...
exports.QueryTeamVestingAccountsRequest = {
    ...
    create: function (base) {
        return exports.QueryTeamVestingAccountsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (_) {
        var message = createBaseQueryTeamVestingAccountsRequest();
        return message;
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.accounts.push(team_1.TeamVestingAccount.decode(reader, reader.uint32()));
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON: function (object) {
        return {
            accounts: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.accounts)
                ? object.accounts.map(function (e) { return team_1.TeamVestingAccount.fromJSON(e); })
                : [],
        };
    },
    toJSON: function (message) {
        ...
        if ((_a = message.accounts) === null || _a === void 0 ? void 0 : _a.length) {
            obj.accounts = message.accounts.map(function (e) { return team_1.TeamVestingAccount.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
        return exports.QueryTeamVestingAccountsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryTeamVestingAccountsResponse();
        message.accounts = ((_a = object.accounts) === null || _a === void 0 ? void 0 : _a.map(function (e) { return team_1.TeamVestingAccount.fromPartial(e); })) || [];
        return message;
    },
};
...
exports.QueryTeamVestingAccountRequest = {
    ...
    create: function (base) {
        return exports.QueryTeamVestingAccountRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryTeamVestingAccountRequest();
...
exports.QueryTeamVestingAccountResponse = {
    encode: function (message, writer) {
        ...
        if (message.account !== undefined) {
            team_1.TeamVestingAccount.encode(message.account, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.account = team_1.TeamVestingAccount.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON: function (object) {
        return { account: isSet(object.account) ? team_1.TeamVestingAccount.fromJSON(object.account) : undefined };
    },
    toJSON: function (message) {
        var obj = {};
        if (message.account !== undefined) {
    ...
    create: function (base) {
        return exports.QueryTeamVestingAccountResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var message = createBaseQueryTeamVestingAccountResponse();
...
exports.QueryTeamVestingStatusRequest = {
    ...
    create: function (base) {
        return exports.QueryTeamVestingStatusRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryTeamVestingStatusRequest();
...
exports.QueryTeamVestingStatusResponse = {
    encode: function (message, writer) {
        ...
        if (message.plan !== undefined) {
            exports.QueryVestingPlan.encode(message.plan, writer.uint32(18).fork()).ldelim();
        }
        if (message.status !== undefined) {
            exports.QueryVestingStatus.encode(message.status, writer.uint32(26).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2:
                    ...
                    message.plan = exports.QueryVestingPlan.decode(reader, reader.uint32());
                    continue;
                case 3:
                    if (tag !== 26) {
                        break;
                    }
                    message.status = exports.QueryVestingStatus.decode(reader, reader.uint32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON: function (object) {
        return {
            ...
            plan: isSet(object.plan) ? exports.QueryVestingPlan.fromJSON(object.plan) : undefined,
            status: isSet(object.status) ? exports.QueryVestingStatus.fromJSON(object.status) : undefined,
        };
    },
    toJSON: function (message) {
        var obj = {};
    ...
    create: function (base) {
        return exports.QueryTeamVestingStatusResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryTeamVestingStatusResponse();
        message.request_date = (_a = object.request_date) !== null && _a !== void 0 ? _a : "";
...
exports.QueryTeamVestingStatusByTimeRequest = {
    ...
    create: function (base) {
        return exports.QueryTeamVestingStatusByTimeRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseQueryTeamVestingStatusByTimeRequest();
...
exports.QueryTeamVestingStatusByTimeResponse = {
    ...
    create: function (base) {
        return exports.QueryTeamVestingStatusByTimeResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a;
        var message = createBaseQueryTeamVestingStatusByTimeResponse();
...
exports.QueryVestingStatus = {
    ...
    create: function (base) {
        return exports.QueryVestingStatus.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d, _e, _f, _g, _h, _j;
        var message = createBaseQueryVestingStatus();
        message.total_vested_amount = (_a = object.total_vested_amount) !== null && _a !== void 0 ? _a : "0";
        message.total_unlocked_amount = (_b = object.total_unlocked_amount) !== null && _b !== void 0 ? _b : "0";
        message.current_claimable_amount = (_c = object.current_claimable_amount) !== null && _c !== void 0 ? _c : "0";
        message.locked_vested_amount = (_d = object.locked_vested_amount) !== null && _d !== void 0 ? _d : "0";
        message.remaining_unvested_amount = (_e = object.remaining_unvested_amount) !== null && _e !== void 0 ? _e : "0";
        message.claimed_amount = (_f = object.claimed_amount) !== null && _f !== void 0 ? _f : "0";
        message.total_rewards = (_g = object.total_rewards) !== null && _g !== void 0 ? _g : "0";
        message.claimed_rewards = (_h = object.claimed_rewards) !== null && _h !== void 0 ? _h : "0";
        message.available_rewards = (_j = object.available_rewards) !== null && _j !== void 0 ? _j : "0";
        return message;
    },
};
...
exports.QueryVestingPlan = {
    ...
    create: function (base) {
        return exports.QueryVestingPlan.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        var message = createBaseQueryVestingPlan();
        message.commencement = (_a = object.commencement) !== null && _a !== void 0 ? _a : "";
        message.token_vesting_start = (_b = object.token_vesting_start) !== null && _b !== void 0 ? _b : "";
        message.token_vesting_finished = (_c = object.token_vesting_finished) !== null && _c !== void 0 ? _c : "";
        message.token_unlock_start = (_d = object.token_unlock_start) !== null && _d !== void 0 ? _d : "";
        message.token_unlock_finished = (_e = object.token_unlock_finished) !== null && _e !== void 0 ? _e : "";
        message.clawback = (_f = object.clawback) !== null && _f !== void 0 ? _f : "0";
        message.clawback_amount = (_g = object.clawback_amount) !== null && _g !== void 0 ? _g : "0";
        message.maximum_vesting_amount = (_h = object.maximum_vesting_amount) !== null && _h !== void 0 ? _h : "0";
        return message;
    },
};
...
var QueryClientImpl = /** @class */ (function () {
    ...
    QueryClientImpl.prototype.TeamInfo = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryTeamInfoResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    QueryClientImpl.prototype.TeamVestingAccounts = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryTeamVestingAccountsResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    QueryClientImpl.prototype.TeamVestingAccount = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryTeamVestingAccountResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    QueryClientImpl.prototype.TeamVestingStatus = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryTeamVestingStatusResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    QueryClientImpl.prototype.TeamVestingStatusByTime = function (request) {
        var data = exports.QueryTeamVestingStatusByTimeRequest.encode(request).finish();
        var promise = this.rpc.request(this.service, "TeamVestingStatusByTime", data);
        return promise.then(function (data) { return exports.QueryTeamVestingStatusByTimeResponse.decode(minimal_1.default.Reader.create(data)); });
    };
