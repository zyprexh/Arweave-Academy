...
exports.Pool = exports.UpgradePlan = exports.Protocol = exports.poolStatusToNumber = exports.poolStatusToJSON = exports.poolStatusFromJSON = exports.PoolStatus = exports.protobufPackage = void 0;
/* eslint-disable */
...
(function (PoolStatus) {
     ...
     */
    PoolStatus["POOL_STATUS_NOT_ENOUGH_DELEGATION"] = "POOL_STATUS_NOT_ENOUGH_DELEGATION";
    /**
     ...
     */
    PoolStatus["POOL_STATUS_VOTING_POWER_TOO_HIGH"] = "POOL_STATUS_VOTING_POWER_TOO_HIGH";
    /**
     ...
     */
    PoolStatus["POOL_STATUS_END_KEY_REACHED"] = "POOL_STATUS_END_KEY_REACHED";
...
exports.Protocol = {
    ...
    create: function (base) {
        return exports.Protocol.fromPartial(base !== null && base !== void 0 ? base : {});
    },
...
exports.UpgradePlan = {
    ...
    create: function (base) {
        return exports.UpgradePlan.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d;
        var message = createBaseUpgradePlan();
...
exports.Pool = {
    encode: function (message, writer) {
        ...
        if (message.protocol !== undefined) {
            exports.Protocol.encode(message.protocol, writer.uint32(130).fork()).ldelim();
        }
        if (message.upgrade_plan !== undefined) {
            exports.UpgradePlan.encode(message.upgrade_plan, writer.uint32(138).fork()).ldelim();
        }
    ...
    fromPartial: function (object) {
        ...
        message.inflation_share_weight = (_m = object.inflation_share_weight) !== null && _m !== void 0 ? _m : "";
        ...
        message.disabled = (_q = object.disabled) !== null && _q !== void 0 ? _q : false;
        ...
        message.upgrade_plan = (object.upgrade_plan !== undefined && object.upgrade_plan !== null)
            ...
            : undefined;
        message.current_storage_provider_id = (_r = object.current_storage_provider_id) !== null && _r !== void 0 ? _r : 0;
        message.current_compression_id = (_s = object.current_compression_id) !== null && _s !== void 0 ? _s : 0;
        message.end_key = (_t = object.end_key) !== null && _t !== void 0 ? _t : "";
        return message;
    },
};
