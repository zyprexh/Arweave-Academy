...
exports.MsgClientImpl = exports.MsgServiceName = exports.MsgUpdateParamsResponse = exports.MsgUpdateParams = exports.MsgSkipUploaderRoleResponse = exports.MsgSkipUploaderRole = exports.MsgClaimUploaderRoleResponse = exports.MsgClaimUploaderRole = exports.MsgVoteBundleProposalResponse = exports.MsgVoteBundleProposal = exports.MsgSubmitBundleProposalResponse = exports.MsgSubmitBundleProposal = exports.voteTypeToNumber = exports.voteTypeToJSON = exports.voteTypeFromJSON = exports.VoteType = exports.protobufPackage = void 0;
/* eslint-disable */
...
(function (VoteType) {
    ...
    VoteType["VOTE_TYPE_UNSPECIFIED"] = "VOTE_TYPE_UNSPECIFIED";
    /** VOTE_TYPE_VALID - VOTE_TYPE_VALID ... */
    VoteType["VOTE_TYPE_VALID"] = "VOTE_TYPE_VALID";
    /** VOTE_TYPE_INVALID - VOTE_TYPE_INVALID ... */
    VoteType["VOTE_TYPE_INVALID"] = "VOTE_TYPE_INVALID";
    /** VOTE_TYPE_ABSTAIN - VOTE_TYPE_ABSTAIN ... */
    VoteType["VOTE_TYPE_ABSTAIN"] = "VOTE_TYPE_ABSTAIN";
    VoteType["UNRECOGNIZED"] = "UNRECOGNIZED";
...
function voteTypeToNumber(object) {
    switch (object) {
        case VoteType.VOTE_TYPE_UNSPECIFIED:
            return 0;
        case VoteType.VOTE_TYPE_VALID:
...
exports.voteTypeToNumber = voteTypeToNumber;
...
exports.MsgSubmitBundleProposal = {
    ...
    create: function (base) {
        return exports.MsgSubmitBundleProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
...
exports.MsgSubmitBundleProposalResponse = {
    ...
    create: function (base) {
        return exports.MsgSubmitBundleProposalResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
...
exports.MsgVoteBundleProposal = {
    ...
    create: function (base) {
        return exports.MsgVoteBundleProposal.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d, _e;
        var message = createBaseMsgVoteBundleProposal();
        ...
        message.pool_id = (_c = object.pool_id) !== null && _c !== void 0 ? _c : "0";
        message.storage_id = (_d = object.storage_id) !== null && _d !== void 0 ? _d : "";
        message.vote = (_e = object.vote) !== null && _e !== void 0 ? _e : VoteType.VOTE_TYPE_UNSPECIFIED;
        return message;
    },
};
...
exports.MsgVoteBundleProposalResponse = {
    ...
    create: function (base) {
        return exports.MsgVoteBundleProposalResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (_) {
        var message = createBaseMsgVoteBundleProposalResponse();
        return message;
...
exports.MsgClaimUploaderRole = {
    ...
    create: function (base) {
        return exports.MsgClaimUploaderRole.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c;
        var message = createBaseMsgClaimUploaderRole();
...
exports.MsgClaimUploaderRoleResponse = {
    ...
    create: function (base) {
        return exports.MsgClaimUploaderRoleResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (_) {
        var message = createBaseMsgClaimUploaderRoleResponse();
        return message;
...
exports.MsgSkipUploaderRole = {
    ...
    create: function (base) {
        return exports.MsgSkipUploaderRole.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d;
        var message = createBaseMsgSkipUploaderRole();
...
exports.MsgSkipUploaderRoleResponse = {
    ...
    create: function (base) {
        return exports.MsgSkipUploaderRoleResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (_) {
        var message = createBaseMsgSkipUploaderRoleResponse();
        return message;
...
var MsgClientImpl = /** @class */ (function () {
    ...
    MsgClientImpl.prototype.SubmitBundleProposal = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgSubmitBundleProposalResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    MsgClientImpl.prototype.VoteBundleProposal = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgVoteBundleProposalResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    MsgClientImpl.prototype.ClaimUploaderRole = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgClaimUploaderRoleResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    MsgClientImpl.prototype.SkipUploaderRole = function (request) {
        ...
        return promise.then(function (data) { return exports.MsgSkipUploaderRoleResponse.decode(minimal_1.default.Reader.create(data)); });
    };
