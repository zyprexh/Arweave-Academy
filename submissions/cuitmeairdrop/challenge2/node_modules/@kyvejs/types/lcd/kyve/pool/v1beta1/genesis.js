...
exports.GenesisState = {
    ...
    fromJSON: function (object) {
        return {
            ...
            pool_list: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.pool_list) ? object.pool_list.map(function (e) { return pool_1.Pool.fromJSON(e); }) : [],
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.pool_list) === null || _a === void 0 ? void 0 : _a.length) {
            obj.pool_list = message.pool_list.map(function (e) { return pool_1.Pool.toJSON(e); });
        }
        if (message.pool_count !== "0") {
