...
exports.GenesisState = {
    ...
    fromJSON: function (object) {
        return {
            ...
            delegator_list: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.delegator_list)
                ? object.delegator_list.map(function (e) { return delegation_1.Delegator.fromJSON(e); })
                : [],
            delegation_entry_list: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.delegation_entry_list)
                ? object.delegation_entry_list.map(function (e) { return delegation_1.DelegationEntry.fromJSON(e); })
                : [],
            delegation_data_list: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.delegation_data_list)
                ? object.delegation_data_list.map(function (e) { return delegation_1.DelegationData.fromJSON(e); })
                : [],
            delegation_slash_list: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.delegation_slash_list)
                ? object.delegation_slash_list.map(function (e) { return delegation_1.DelegationSlash.fromJSON(e); })
                : [],
            undelegation_queue_entry_list: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.undelegation_queue_entry_list)
            ...
            queue_state_undelegation: isSet(object.queue_state_undelegation)
                ...
                : undefined,
            redelegation_cooldown_list: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.redelegation_cooldown_list)
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.delegator_list) === null || _a === void 0 ? void 0 : _a.length) {
            obj.delegator_list = message.delegator_list.map(function (e) { return delegation_1.Delegator.toJSON(e); });
        }
        if ((_b = message.delegation_entry_list) === null || _b === void 0 ? void 0 : _b.length) {
            obj.delegation_entry_list = message.delegation_entry_list.map(function (e) { return delegation_1.DelegationEntry.toJSON(e); });
        }
        if ((_c = message.delegation_data_list) === null || _c === void 0 ? void 0 : _c.length) {
            obj.delegation_data_list = message.delegation_data_list.map(function (e) { return delegation_1.DelegationData.toJSON(e); });
        }
        if ((_d = message.delegation_slash_list) === null || _d === void 0 ? void 0 : _d.length) {
            obj.delegation_slash_list = message.delegation_slash_list.map(function (e) { return delegation_1.DelegationSlash.toJSON(e); });
        }
        if ((_e = message.undelegation_queue_entry_list) === null || _e === void 0 ? void 0 : _e.length) {
        ...
        if (message.queue_state_undelegation !== undefined) {
            obj.queue_state_undelegation = delegation_1.QueueState.toJSON(message.queue_state_undelegation);
        }
        if ((_f = message.redelegation_cooldown_list) === null || _f === void 0 ? void 0 : _f.length) {
            obj.redelegation_cooldown_list = message.redelegation_cooldown_list.map(function (e) { return delegation_1.RedelegationCooldown.toJSON(e); });
        }
        return obj;
    },
