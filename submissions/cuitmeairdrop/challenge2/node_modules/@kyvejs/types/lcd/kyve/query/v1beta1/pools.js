...
exports.QueryPoolClientImpl = exports.QueryPoolServiceName = exports.QueryPoolResponse = exports.QueryPoolRequest = exports.PoolResponse = exports.QueryPoolsResponse = exports.QueryPoolsRequest = exports.protobufPackage = void 0;
/* eslint-disable */
...
var funders_1 = require("../../funders/v1beta1/funders");
...
exports.QueryPoolsResponse = {
    ...
    fromJSON: function (object) {
        return {
            pools: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.pools) ? object.pools.map(function (e) { return exports.PoolResponse.fromJSON(e); }) : [],
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.pools) === null || _a === void 0 ? void 0 : _a.length) {
            obj.pools = message.pools.map(function (e) { return exports.PoolResponse.toJSON(e); });
        }
        if (message.pagination !== undefined) {
...
exports.PoolResponse = {
    encode: function (message, writer) {
        ...
        for (var _b = 0, _c = message.fundings; _b < _c.length; _b++) {
            var v = _c[_b];
            funders_1.Funding.encode(v, writer.uint32(82).fork()).ldelim();
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 10:
                    ...
                    message.fundings.push(funders_1.Funding.decode(reader, reader.uint32()));
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON: function (object) {
        return {
            ...
            stakers: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.stakers) ? object.stakers.map(function (e) { return globalThis.String(e); }) : [],
            ...
            fundings: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.fundings) ? object.fundings.map(function (e) { return funders_1.Funding.fromJSON(e); }) : [],
        };
    },
    toJSON: function (message) {
        var _a, _b;
        ...
        if (message.bundle_proposal !== undefined) {
            obj.bundle_proposal = bundles_1.BundleProposal.toJSON(message.bundle_proposal);
        }
        ...
        if ((_b = message.fundings) === null || _b === void 0 ? void 0 : _b.length) {
            obj.fundings = message.fundings.map(function (e) { return funders_1.Funding.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
    ...
    fromPartial: function (object) {
        ...
        message.status = (_e = object.status) !== null && _e !== void 0 ? _e : pool_1.PoolStatus.POOL_STATUS_UNSPECIFIED;
        message.account = (_f = object.account) !== null && _f !== void 0 ? _f : "";
        message.account_balance = (_g = object.account_balance) !== null && _g !== void 0 ? _g : "0";
        message.fundings = ((_h = object.fundings) === null || _h === void 0 ? void 0 : _h.map(function (e) { return funders_1.Funding.fromPartial(e); })) || [];
        return message;
    },
};
...
var QueryPoolClientImpl = /** @class */ (function () {
    function QueryPoolClientImpl(rpc, opts) {
        this.service = (opts === null || opts === void 0 ? void 0 : opts.service) || exports.QueryPoolServiceName;
        this.rpc = rpc;
    ...
    QueryPoolClientImpl.prototype.Pools = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryPoolsResponse.decode(minimal_1.default.Reader.create(data)); });
    };
    QueryPoolClientImpl.prototype.Pool = function (request) {
        ...
        return promise.then(function (data) { return exports.QueryPoolResponse.decode(minimal_1.default.Reader.create(data)); });
    };
