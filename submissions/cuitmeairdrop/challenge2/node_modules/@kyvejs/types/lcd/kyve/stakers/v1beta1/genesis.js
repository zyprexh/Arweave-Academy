...
exports.GenesisState = {
    ...
    fromJSON: function (object) {
        return {
            ...
            staker_list: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.staker_list)
                ...
                : [],
            valaccount_list: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.valaccount_list)
    ...
    toJSON: function (message) {
        ...
        if ((_b = message.valaccount_list) === null || _b === void 0 ? void 0 : _b.length) {
            obj.valaccount_list = message.valaccount_list.map(function (e) { return stakers_1.Valaccount.toJSON(e); });
        }
