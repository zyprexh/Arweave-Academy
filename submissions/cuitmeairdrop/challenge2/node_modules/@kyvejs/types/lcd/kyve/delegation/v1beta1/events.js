...
exports.EventSlash = exports.EventWithdrawRewards = exports.EventRedelegate = exports.EventUndelegate = exports.EventStartUndelegation = exports.EventDelegate = exports.EventUpdateParams = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.EventDelegate = {
    ...
    create: function (base) {
        return exports.EventDelegate.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c;
        var message = createBaseEventDelegate();
...
exports.EventRedelegate = {
    ...
    create: function (base) {
        return exports.EventRedelegate.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial: function (object) {
        var _a, _b, _c, _d;
        var message = createBaseEventRedelegate();
...
function createBaseEventSlash() {
    return { pool_id: "0", staker: "", amount: "0", slash_type: delegation_1.SlashType.SLASH_TYPE_UNSPECIFIED };
}
exports.EventSlash = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_1.default.Writer.create(); }
        ...
        if (message.slash_type !== delegation_1.SlashType.SLASH_TYPE_UNSPECIFIED) {
            writer.uint32(32).int32((0, delegation_1.slashTypeToNumber)(message.slash_type));
        }
        return writer;
    },
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 4:
                    ...
                    message.slash_type = (0, delegation_1.slashTypeFromJSON)(reader.int32());
                    continue;
            }
            if ((tag & 7) === 4 || tag === 0) {
                break;
    ...
    fromJSON: function (object) {
        return {
            ...
            staker: isSet(object.staker) ? globalThis.String(object.staker) : "",
            amount: isSet(object.amount) ? globalThis.String(object.amount) : "0",
            slash_type: isSet(object.slash_type) ? (0, delegation_1.slashTypeFromJSON)(object.slash_type) : delegation_1.SlashType.SLASH_TYPE_UNSPECIFIED,
        };
    },
    toJSON: function (message) {
        var obj = {};
    ...
    fromPartial: function (object) {
        ...
        message.staker = (_b = object.staker) !== null && _b !== void 0 ? _b : "";
        message.amount = (_c = object.amount) !== null && _c !== void 0 ? _c : "0";
        message.slash_type = (_d = object.slash_type) !== null && _d !== void 0 ? _d : delegation_1.SlashType.SLASH_TYPE_UNSPECIFIED;
        return message;
    },
};
