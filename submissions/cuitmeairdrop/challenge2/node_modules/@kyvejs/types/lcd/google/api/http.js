...
exports.Http = {
    ...
    fromJSON: function (object) {
        return {
            rules: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.rules) ? object.rules.map(function (e) { return exports.HttpRule.fromJSON(e); }) : [],
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.rules) === null || _a === void 0 ? void 0 : _a.length) {
            obj.rules = message.rules.map(function (e) { return exports.HttpRule.toJSON(e); });
        }
        if (message.fully_decode_reserved_expansion !== false) {
...
exports.HttpRule = {
    ...
    toJSON: function (message) {
        ...
        if ((_a = message.additional_bindings) === null || _a === void 0 ? void 0 : _a.length) {
            obj.additional_bindings = message.additional_bindings.map(function (e) { return exports.HttpRule.toJSON(e); });
        }
        return obj;
    },
    create: function (base) {
